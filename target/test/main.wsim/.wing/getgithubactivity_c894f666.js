...
exports.handler = async function(event) {
  $handler = $handler ?? (
          ...
          require("/Users/polamoros/Projects/WingCloud/wing-bot/target/test/main.wsim/.wing/inflight.$Closure1-1.js")({
            $Utils: 
        ...
        ,
            ...
            $token: (function() {
  let handle = process.env.SECRET_HANDLE_445002a3;
  if (!handle) {
    throw new Error("Missing environment variable: SECRET_HANDLE_445002a3");
  }
